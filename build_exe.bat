@echo off
title Pulse Gaming Optimizer - Build EXE
echo ============================================
echo  PULSE GAMING OPTIMIZER - A gerar .EXE nativo
echo ============================================
echo.
...
%PYTHON_CMD% -m PyInstaller --noconfirm --clean PulseOptimizer.spec

echo.
echo [3/3] Pronto!
echo O teu EXE esta em: dist\PulseOptimizer.exe
