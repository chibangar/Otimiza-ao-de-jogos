...
python -m PyInstaller --noconfirm --onefile --windowed --uac-admin --name "MidnightOptimizer" --add-data "index.html;." --add-data "styles.css;." --add-data "renderer.js;." --add-data "assets;assets" app.py
